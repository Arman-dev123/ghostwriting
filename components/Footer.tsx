...
// const Footer: React.FC = () => {
//   return (
//     <footer className="bg-neutral-950 text-white pt-16 md:pt-20 pb-10 border-t border-[#D4AF37]/30">
//       <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
//         <div className="col-span-1 sm:col-span-2">
//           <Link to={Page.Home} className="inline-block mb-6 hover:opacity-90 transition-opacity">
//             <Logo variant="dark" className="!items-start" />
//           </Link>
//           <p className="text-neutral-400 max-w-sm leading-relaxed mb-6 text-sm">
//             Crafting legacies through elite storytelling and world-class publishing services. 
//             Excellence, confidentiality, and literary mastery in every leaf.
//           </p>
//           <div className="flex space-x-4">
...
//           <h4 className="font-serif text-lg font-bold mb-6 text-[#D4AF37]">Quick Links</h4>
//           <ul className="space-y-4">
//             <li><Link to={Page.Home} className="text-neutral-400 hover:text-[#D4AF37] transition-colors text-sm">Home</Link></li>
//             <li><Link to={Page.Services} className="text-neutral-400 hover:text-[#D4AF37] transition-colors text-sm">Services</Link></li>
//             <li><Link to={Page.Process} className="text-neutral-400 hover:text-[#D4AF37] transition-colors text-sm">Our Process</Link></li>
//             <li><Link to={Page.Quotation} className="text-neutral-400 hover:text-[#D4AF37] transition-colors text-sm">Get Quote</Link></li>
//           </ul>
//         </div>
...
//             <li className="flex flex-col">
//               <span className="text-[10px] uppercase tracking-widest text-neutral-500 mb-1">Email</span>
//               <a href="mailto:hello@goldleaf.luxury" className="text-[#D4AF37] hover:underline text-sm">goldleafghostwriting@gmail.com</a>
//             </li>
//             <li className="flex flex-col">
//               <span className="text-[10px] uppercase tracking-widest text-neutral-500 mb-1 text-sm">Phone</span>
//               <span className="text-white">+1 (800) GOLD-LEAF</span>
//             </li>
//           </ul>
//         </div>
...
//       <div className="max-w-7xl mx-auto px-6 pt-10 border-t border-neutral-800 text-center text-neutral-500 text-[10px] uppercase tracking-[0.2em]">
//         <p>&copy; {new Date().getFullYear()} Gold Leaf Ghostwriters. All Rights Reserved.</p>
//       </div>
//     </footer>
//   );
// };
    ...
    <footer className="bg-neutral-950 text-white pt-16 md:pt-20 pb-10 border-t border-[#D4AF37]/30">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        ...
        <div className="col-span-1 sm:col-span-2">
          ...
          <div className="flex space-x-4">
            {/* Focused Social Icons: LinkedIn and Instagram */}
            {['in', '📸'].map(icon => (
              <div 
                key={icon} 
                className="w-10 h-10 rounded-full border border-neutral-800 flex items-center justify-center hover:border-[#D4AF37] hover:text-[#D4AF37] transition-all cursor-pointer font-bold text-xs"
              >
                {icon}
              </div>
            ))}
        ...
        <div>
          ...
          <ul className="space-y-4 text-neutral-400">
            <li className="flex flex-col">
              <span className="text-[10px] uppercase tracking-widest text-neutral-500 mb-1">Email</span>
              <a 
                href="mailto:goldleafghostwriting@gmail.com" 
                className="text-[#D4AF37] hover:underline text-sm"
              >
                goldleafghostwriting@gmail.com
              </a>
            </li>
            <li className="flex flex-col border-t border-neutral-900 pt-4">
              {/* <span className="text-[10px] uppercase tracking-widest text-neutral-500 mb-1">Global Presence</span>
              <span className="text-white text-sm">Mayfair, London • 5th Ave, NY</span> */}
            </li>
          </ul>
        </div>
      </div>
      ...
      {/* Copyright Bar */}
      <div className="max-w-7xl mx-auto px-6 pt-10 border-t border-neutral-800 text-center text-neutral-500 text-[10px] uppercase tracking-[0.2em]">
        <p>&copy; {new Date().getFullYear()} Gold Leaf Ghostwriting. All Rights Reserved.</p>
      </div>
    </footer>
  );
};
