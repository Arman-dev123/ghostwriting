...
//           <h1 className="text-5xl md:text-6xl font-serif font-bold mb-8">Questions About <span className="gold-text-gradient">Gold Leaf Ghostwriting</span></h1>
//           <p className="text-lg text-neutral-600">
//             Transparency is a core value at Gold Leaf Ghostwriting. Here are the answers to the questions we hear most often from our prospective authors.
//           </p>
//         </header>

//         <div className="space-y-8">
//           {FAQS.map((faq, index) => (
//             <div key={index} className="glass-card p-8 rounded-2xl border border-[#D4AF37]/10 hover:border-[#D4AF37]/40 transition-all">
//               <h2 className="text-xl font-serif font-bold mb-4 text-neutral-900">{faq.question}</h2>
//               <p className="text-neutral-600 leading-relaxed">{faq.answer}</p>
//             </div>
//           ))}
//         </div>

//         <div className="mt-20 text-center p-12 bg-neutral-950 text-white rounded-3xl">
//           <h3 className="text-2xl font-serif font-bold mb-4">Still Have Questions?</h3>
//           <p className="text-neutral-400 mb-8">Every project is unique. We would love to discuss your specific needs in a private consultation.</p>
//           <a href="/#/quotation" className="px-10 py-5 gold-gradient text-white rounded-full font-bold tracking-widest uppercase text-sm inline-block">Contact Us Directly</a>
//         </div>
//       </div>
//     </div>
//   );
