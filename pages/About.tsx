...
const About: React.FC = () => {
  return (
    <div className="pt-24 md:pt-32 pb-16 md:pb-24 min-h-screen bg-white dark:bg-black transition-colors duration-500">
      {/* 1. Enhanced SEO for Agency Authority */}
      <SEO 
        title="About Gold Leaf | Professional Ghostwriters & Book Publishing Agency" 
        description="Meet the elite team behind Gold Leaf. We specialize in professional ghostwriting, Amazon KDP optimization, and high-end author website design for industry leaders."
        url="https://goldleaf-ghostwriting-one.vercel.app/about"
      />
      <div className="max-w-7xl mx-auto px-6">
        <header className="mb-12 md:mb-20 text-center max-w-4xl mx-auto">
          {/* 2. H1 Optimized for Agency keywords */}
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-serif font-bold mb-6 md:mb-8 text-neutral-900 dark:text-white">
            The Visionaries Behind <span className="gold-text-gradient">Professional Ghostwriting</span>
          </h1>
          <p className="text-base md:text-xl text-neutral-600 dark:text-neutral-400 leading-relaxed">
            Founded on excellence and discretion, Gold Leaf was established to provide **Amazon book publishing** expertise and a voice to the world's most influential authors.
          </p>
        </header>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center mb-16 md:mb-24">
          <div className="order-2 md:order-1 text-center md:text-left">
            <h2 className="text-2xl md:text-3xl font-serif font-bold mb-6 text-neutral-900 dark:text-white">Our Mission for Authors</h2>
            <p className="text-sm md:text-base text-neutral-600 dark:text-neutral-400 leading-relaxed mb-6">
              At Gold Leaf, we believe every transformative idea deserves a worthy chronicler. Our mission is to bridge the gap between initial inspiration and global **Amazon KDP launch**.
            </p>
            <p className="text-sm md:text-base text-neutral-600 dark:text-neutral-400 leading-relaxed">
              Our team consists of veteran editors and **author website developers** who understand exactly what it takes to dominate today's competitive literary marketplace.
            </p>
          </div>
          <div className="order-1 md:order-2">
            <img 
              src="https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?auto=format&fit=crop&w=800&q=80" 
              alt="Elite Ghostwriting and Book Publishing Team" 
              className="rounded-2xl md:rounded-3xl shadow-2xl grayscale w-full object-cover aspect-[4/3] md:aspect-auto border border-[#D4AF37]/20"
            />
          </div>
        </div>

        <div className="bg-[#F9F6EE] dark:bg-neutral-900/50 rounded-2xl md:rounded-3xl p-8 md:p-12 text-center border border-[#D4AF37]/10">
          <h2 className="text-2xl md:text-3xl font-serif font-bold mb-6 md:mb-8 text-neutral-900 dark:text-[#D4AF37]">The Gold Leaf Standard</h2>
          <p className="max-w-3xl mx-auto text-sm md:text-base text-neutral-700 dark:text-neutral-300 leading-relaxed italic">
            "In rare books, gold leaf signifies high value. We bring that same prestige to your **author branding** and **book publishing** journey, ensuring your story stands the test of time."
          </p>
        </div>
      </div>
    </div>
